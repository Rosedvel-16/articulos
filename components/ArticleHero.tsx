...
export function ArticleHero({ title, categorySeed }: ArticleHeroProps) {
      ...
      <div className="relative h-[320px] w-full md:h-[380px]">
        ...
        <div className="relative z-10 flex h-full flex-col justify-end px-4 pb-8 md:px-6 md:pb-10">
          <div className="mx-auto w-full max-w-3xl">
            ...
            <p className="mt-3 max-w-2xl font-display text-2xl font-semibold leading-tight tracking-tight text-white md:text-3xl">
              {title}
            </p>
          </div>
        </div>
